...
RSpec.describe "Toots index", type: :feature do
  ...
  it "shows the toots" do
    FactoryBot.create :toot, challenge:, completed: true, summary: "DONE!", updated_at: Time.zone.parse("2005-01-04T10:00:00Z"), username: "phil"
    FactoryBot.create :toot, completed: true, username: "phil"
    FactoryBot.create :toot, challenge:, summary: "Not yet", updated_at: Time.zone.parse("2005-01-05T11:22:00Z"), username: "fabian"
